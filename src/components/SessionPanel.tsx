...
export function SessionPanel({ sessions, selectedSessionId, onCreate, onSelect, onDelete, footer }: SessionPanelProps) {
  ...
  return (
    <aside className="session-panel">
      ...
      {footer ? <div className="session-panel-footer">{footer}</div> : null}
    </aside>
  );
}
